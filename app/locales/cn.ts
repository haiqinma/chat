...
const cn = {
  ...
  Auth: {
    ...
    MissingAccount: "请先输入或选择钱包账户地址",
    MissingWalletAccount: "未获取到钱包账户",
    ...
    CentralLoginSuccess: "钱包身份登录成功",
    CentralExchangeFailed: (error: string) =>
      `钱包身份授权码兑换失败: ${error}`,
    CentralRequestCreated: "已创建钱包身份授权请求，跳转认证页",
    CentralRequestFailed: (error: string) =>
      `创建钱包身份授权请求失败: ${error}`,
    CentralTotpTitle: "通行证授权",
    CentralTotpDescription: "使用本地通行证完成钱包身份授权。",
